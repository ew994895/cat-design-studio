...
export const CAT_PROFILES = Object.freeze([
  ...
  profile({
    ...
    special: "Throws a grappling line during ordinary tier jumps and glides into position.",
    atlasSet: "iteration-four-a",
    atlas: [0, 2],
  ...
  profile({
    ...
    name: "Webpaw",
    rarity: "epic",
    tagline: "no rolling toy escapes the web",
    personality: "acrobatic · helpful · excitable",
    special: "Fires a one-shot web tether that slings the ball back toward its paws.",
    atlasSet: "iteration-four-a",
    atlas: [1, 2],
